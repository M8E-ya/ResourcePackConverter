...
public class HorseArmorTextureConverter1_21_10 extends Converter {
    ...
    public void convert(Pack pack) throws IOException {
        ...
        if (horseArmorPath.toFile().exists() && horseArmorPath.resolve("horse_armor_leather.png").toFile().exists()) {
            Logger.log("[WARNING] In 1.21.10, horse_armor_leather.png was split into a base layer and an overlay layer.");
            Logger.log("[WARNING] You must manually separate the leather and buckles from horse_armor_leather.png into two files.");
        }
    }
}
